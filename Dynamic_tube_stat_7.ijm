...
seconds_per_frame = 5;//getNumber("enter time between frames (in seconds)", 1);
minutes_per_frame=seconds_per_frame/60; //gets the minutes per frame
pixelsize = 0.108;// um getNumber("enter pixel size ( in um) ", 0.120  for tirf   or 0.108 for DF) ;
