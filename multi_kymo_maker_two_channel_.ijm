/*  
 A macro to generate a montage of kymographs from darkfiled polarity marked seed experiments. The Seeds should be channel 1 and will be blue
...
kymoLineWidth=3; //set the line width for the kymo maker
...
*/
run("Merge Channels...", "c1=*None* c2=*None* c3=blkymo  c4=graykymo create keep "); // Merge the channels for saving as composites

selectImage("Composite");
saveAs("Tiff", savedir+"tube"+i+"_Composite_"+moviename);
close("*Composite*");

run("Merge Channels...", "c1=graykymo c2=*None* c3=blkymo"); // Merge the channels for the analysis montage?
selectImage("RGB");
